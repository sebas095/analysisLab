...
module.exports = (app, mountPoint) => {
  ...
  // POST
  router.post('/create', sessionController.loginRequired, quotationController.create);
  router.post('/search', sessionController.loginRequired, quotationController.find);

  // PUT
  router.put('/approval/:id', sessionController.loginRequired, quotationController.approval);
  router.put('/:id/delete', sessionController.loginRequired, quotationController.changeState);
  router.put('/:id', sessionController.loginRequired, quotationController.edit);

  // DELETE
  router.delete('/delete/:id', sessionController.loginRequired, quotationController.delete);
